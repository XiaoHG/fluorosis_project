...
\begin{itemize}
    ...
    \item \textbf{Cumulative:} Ordinal regression via cumulative link model with threshold-based probability estimation. $P(y \leq k) = \sigma(\theta_k - z)$, where $\theta_k$ are learnable thresholds.
